...
-  **o_format_lang(value, lang_code=False, digits=None, grouping=True,
   ...
   Returns a formatted numeric or monetary value according to the
   context language and timezone.

-  **o_format_date(value, lang_code=False, date_format=False)** Returns
   a formatted date or time value according to the context language and
   timezone.
